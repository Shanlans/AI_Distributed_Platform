...
def build_gcn(inputs, num_classes, preset_model='GCN', frontend="ResNet101", weight_decay=1e-5, is_training=True, upscaling_method="bilinear"):
    """
    ...
    logits, end_points, frontend_scope  = frontend_builder.build_frontend(inputs, frontend, is_training=is_training)
